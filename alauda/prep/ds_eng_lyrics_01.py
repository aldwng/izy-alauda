...
prep_out = 'C:/Dev/ds/eng_lyrics_01.txt'
prep_train_out = 'C:/Dev/ds/eng_lyrics_train_01.txt'
prep_valid_out = 'C:/Dev/ds/eng_lyrics_valid_01.txt'
prep_test_out = 'C:/Dev/ds/eng_lyrics_test_01.txt'
...
pd_data['age'] = pd_data['age'].astype(str).str[2] + '0s'
